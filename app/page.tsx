...
export default function HomePage() {
  return (
    <main className="min-h-screen py-5 px-5 text-black bg-white flex flex-col">
      <Logo width={200} />
      <div className="flex-1 flex justify-center">
        <div className="max-w-[80%] w-full flex sm:flex-row flex-col items-center text-center ">
          ...
          />
          <div
            className="text-black sm:w-1/2 w-full flex flex-col justify-center items-center "
            style={{ fontFamily: "var(--font-custom)" }}
          >
            <h1 className="text-4xl font-bold mb-4">
              Bienvenido a App Robokids
            </h1>
